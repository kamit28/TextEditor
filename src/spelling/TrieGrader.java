...
public class TrieGrader {
	...
	private void testAddWords(AutoCompleteDictionaryTrie ac) {
		...
		appendTestString(3,
				"Adding more words to dictionary trie (testing size after insertions)...");
	...
	private void testWordsInOut(AutoCompleteDictionaryTrie ac) {
		...
		feedback.append("'test' in dictionary: " + ac.isWord("test")
				+ ". 'testcases' in dictionary: " + ac.isWord("testcases")
				+ ". 'testone' in dictionary: " + ac.isWord("testone") + ".");
	...
	private void testPredictions(AutoCompleteDictionaryTrie ac) {
		...
		feedback.append("predictCompletions returned " + auto.size()
				+ " elements.");
		...
		feedback.append("predictCompletions found " + auto.size()
				+ " elements.");
		...
		appendTestString(18,
				"Testing if list is sorted from shortest to longest...");
		feedback.append("Check above output.");

		List<String> partialList = auto.subList(0, 5);

		appendTestString(19,
				"Testing if list contains correct shorter words...");
		feedback.append("Check above output.");
